require("SKL");
setI18nR(true,'technology','kovarex-enrichment-process','angel');
setI18nR(true,'technology','oil-gathering','angel');
setI18nR(true,'recipe','nuclear-fuel-reprocessing','angel');
setI18nR(true,'recipe','uranium-fuel-cell','angel');
