...
if p then setI18nD(false,o,l,a,r) end end end end
...
function enforceI18nB(p,o,l,a) if data.raw[o] then if data.raw[o][l] then data.raw[o][l].localised_name={a..'-name.'..l}
if p then data.raw[o][l].localised_description={a..'-description.'..l} end end end end
